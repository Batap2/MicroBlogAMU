...
public class ClientSocketHandlerMaster implements Runnable, ClientSocketHandler{
    ...
    public ClientSocketHandlerMaster(Socket s){
        this.socket = s;
    }
    ...
    private void publish() throws IOException {
        ...
        Server.getMasterSocket().sendToServer(received);
    }
